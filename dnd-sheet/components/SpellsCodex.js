                        ...
                        return (
                            <div key={spell.name}>
                                <a href={tag} className="flex border-b-2 border-solid pb-0.5 px-1 cursor-pointer hover:bg-slate-200 focus:bg-sky-400" onClick={handleSpellSelect(spell)}>
                                    ...
                                    <span className="basis-1/4 font-light text-center">{spell.level}</span>
                                    <span className="basis-1/4 font-light text-center">{spell.casting_time}</span>
                                    <span className="basis-1/2 font-light text-center">{spell.school}</span>
                                </a>
                            </div>
                        );
                    })}
